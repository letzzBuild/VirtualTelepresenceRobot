#PROJECT TITLE : VIRTUAL TELEPRESENCE ROBOT 
#AUTHOR : GAUTAM PATIL
#THIS IS THE MAIN SCRIPT WHICH IS RESPONSIBLE FOR CONTROLLING MOVEMENT OF SERVO MOTARS FOR PAN TILT 

#ALL LIBRARIES REQUIRED IMPORTING WORK
...
#GPIO PINS MODE SETUP
GPIO.setmode(GPIO.BOARD)
#GPIO PINS SET AS OUTPUT FOR CONTROLLING SERVOS
GPIO.setup(38,GPIO.OUT)
GPIO.setup(40,GPIO.OUT)

#SET 38 AND 40 PIN AS PWN WITH 50HZ SIGNAL
horizontal = GPIO.PWM(38,50)         #horizontal movement
vertical = GPIO.PWM(40,50)           #vertical movement
...
#MOVE SERVOS LEFT RIGHT UP DOWN
vertical.ChangeDutyCycle(2)
horizontal.ChangeDutyCycle(2)
sleep(0.5)
vertical.ChangeDutyCycle(7.5)
horizontal.ChangeDutyCycle(7.5)
sleep(0.5)
vertical.ChangeDutyCycle(12)
horizontal.ChangeDutyCycle(12)
sleep(0.5)
vertical.ChangeDutyCycle(7.5)
horizontal.ChangeDutyCycle(7.5)
...
while 1 :
   try:
        ...
        vertical.ChangeDutyCycle(x_duty)
        horizontal.ChangeDutyCycle(y_duty)
        sleep(0.05)
